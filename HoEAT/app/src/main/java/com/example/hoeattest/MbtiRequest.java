...
public class MbtiRequest extends StringRequest {

    // 서버 URL 설정 ( PHP 파일 연동 )
    final static private String URL = "http://222.105.251.88:15100/test3.php";
    private Map<String, String> map;


    public MbtiRequest(String userID, String userPassword, Response.Listener<String> listener) {
        super(Method.POST, URL, listener, null);

        map = new HashMap<>();
        map.put("userMbti",userID);
